...
namespace MyDummySQL.DAOs
{
    public class MyDummySQLSettingsSingleton
    {
        ...
        public const string KeygridColPri = "gridColPri";
        ...
        public static void getValue(string headerText, string strgKey, out string strgValue)
        {
            strgValue = getValue(headerText, strgKey);
        }
        ...
        public static void getValue(DAOContext con, string headerText, string strgKey, out string strgValue)
        {
            strgValue = getValue(con, headerText, strgKey);
        }
